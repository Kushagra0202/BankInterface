...
public class MiniStatement extends javax.swing.JFrame {
    ...
    private void displayTR(){
        try{
            ...
            String q = "SELECT * FROM TRANSACTIONTABLE where AccNum='"+MyAccNum+"'";
            ...
            while (rs.next()){
                model.addRow(new Object[]{rs.getInt("AccNum"),rs.getDate("TDate"),rs.getInt("Amount"),rs.getString("Type")});
            }
